...
public class StringFormatTest {  
	...
	@Test
	public void test() {
		System.out.println(String.format("%1$s", 1234, 5678));
		System.out.println(String.format("%2$s", 1234, 5678));
		System.out.println(String.format("%1$s%2$s", 1234, 5678));
		System.out.println(String.format("%s", 1234, 5678));
		System.out.println(String.format("%s%06d", 1234, 5678));
		
		System.out.println(String.format("{msg:'更新feature失败原因 ：{}'}", "ssss"));
		
//				loger.info(String.format("{msg:'更新feature失败原因 ：{}'}", updateFeatureById.getErrorMsg()));
		
		/*assertTrue(String.format("%1$s", 1234, 5678).equals("1234")); // 指向第一个参数转换为字符串
		assertTrue(String.format("%1$s%2$s", 1234, 5678).equals("12345678"));// 将两个参数格式化为字符串,并连接在一起
		assertTrue(String.format("%s", 1234, 5678).equals("1234")); // 指向第一个参数转换为字符串
		assertTrue(String.format("%s%06d", 1234, 5678).equals("1234"));// 将第一个格式化为“1234” 第二个格式化005678 w
*/	}
