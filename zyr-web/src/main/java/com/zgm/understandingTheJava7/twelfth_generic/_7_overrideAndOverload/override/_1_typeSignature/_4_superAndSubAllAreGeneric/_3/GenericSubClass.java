 ...
 * http://www.etong.com/
 */
package com.zgm.understandingTheJava7.twelfth_generic._7_overrideAndOverload.override._1_typeSignature._4_superAndSubAllAreGeneric._3;
...
public class GenericSubClass<S extends Number> extends GenericSuperClass<S> {
	...
	//编译错误:与 public void method(S obj)不能共存 
	/*
	@Override
	public void method(Number nmber) {
